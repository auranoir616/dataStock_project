<aside>
  ...
  ?>
    ...
    <ul class="list-group list-group-flush">
            ...
            <div id="flush-collapseOne1" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">
                {{-- <div class="list-group"> --}}
                  <ul class="list-group list-group-flush">
                  <a href="/purchaseOrder" class="list-group-item list-group-item-action" >
                    ...
                    <a href="/return" class="list-group-item list-group-item-action" >
                      ...
                      Return Order</a>
                   <a href="/receiveGoods" class="list-group-item list-group-item-action" >
                ...
                <ul class="list-group list-group-flush">
                  <a href="/shipping" class="list-group-item list-group-item-action">
                    ...
                    <a href="/order-history" class="list-group-item list-group-item-action">
                      ...
                      Order</a>
                    <a href="/broken-history" class="list-group-item list-group-item-action">
        ...
        <i class="bi bi-android2"></i><a href="/currentStock" class="list-group-item list-group-item-action">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-stack" viewBox="0 0 16 16">
            <path d="m14.12 10.163 1.715.858c.22.11.22.424 0 .534L8.267 15.34a.6.6 0 0 1-.534 0L.165 11.555a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.66zM7.733.063a.6.6 0 0 1 .534 0l7.568 3.784a.3.3 0 0 1 0 .535L8.267 8.165a.6.6 0 0 1-.534 0L.165 4.382a.299.299 0 0 1 0-.535z"/>
            <path d="m14.12 6.576 1.715.858c.22.11.22.424 0 .534l-7.568 3.784a.6.6 0 0 1-.534 0L.165 7.968a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0z"/>
          </svg>
          Current stock</a>
        <a href="/productlist" class="list-group-item list-group-item-action">
            ...
            <div class="accordion-body">
                <ul class="list-group list-group-flush">
                    {{-- <li class="list-group-item">
                      ...
                      setting</li> --}}
                    <a href="/listUsers" class="list-group-item list-group-item-action">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                        <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
                      </svg>
                      List Users</a>
                    <a href="/addUserForm" class="list-group-item list-group-item-action">
